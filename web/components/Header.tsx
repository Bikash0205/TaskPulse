...
export const Header: React.FC<HeaderProps> = ({ projects }) => {
  ...
  return (
    <>
      <header className="sticky top-0 z-40 border-b border-[#E9F1FF] dark:border-[#1E293B] bg-white/95 dark:bg-[#0B0F19]/95 backdrop-blur-xl px-3 sm:px-6 py-2.5 sm:py-3 flex items-center justify-between gap-2 sm:gap-4 transition-colors duration-200">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5">
          ...
          {(!user || user.email?.endsWith("@taskpulse.internal")) && (
            <button
              ...
              className="flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-1.5 rounded-xl bg-white dark:bg-[#151C2C] border border-[#E9F1FF] dark:border-[#1E293B] hover:border-[#756EF3] shadow-xs text-xs font-medium text-[#002055] dark:text-[#F8FAFC] hover:bg-slate-50 dark:hover:bg-slate-800 transition-all cursor-pointer"
            ...
            <>
              ...
              {isAdmin && (
                <button
                  ...
                  className="flex items-center gap-1.5 px-2 sm:px-2.5 py-1.5 rounded-xl bg-[#F0EFFF] dark:bg-[#756EF3]/15 hover:bg-[#E2E0FD] dark:hover:bg-[#756EF3]/25 border border-[#756EF3]/30 text-[#756EF3] dark:text-[#818CF8] text-xs font-semibold shadow-xs transition-all cursor-pointer"
                >
              ...
              {isPermanentAdmin ? (
                <div
                  className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-xl bg-[#F0EFFF] dark:bg-[#756EF3]/15 border border-[#756EF3]/30 text-xs font-bold text-[#756EF3] dark:text-[#818CF8] shadow-xs"
                ...
                >
                  ...
                  <span className="hidden sm:inline">Primary Admin</span>
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-1.5 px-2 sm:px-3 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-xs text-slate-800 dark:text-slate-200 hover:border-slate-300 dark:hover:border-slate-700 transition-colors"
                  >
                    <span className="text-slate-500 dark:text-slate-400 hidden sm:inline">Role:</span>
                    <span
              ...
              <div className="flex items-center gap-1.5 sm:gap-2 pl-1.5 sm:pl-2 border-l border-slate-200 dark:border-slate-800">
                ...
                <button
                  ...
                  title="Sign Out"
                  aria-label="Sign Out"
                  className="flex items-center gap-1.5 px-2 sm:px-2.5 py-1.5 rounded-xl text-xs font-medium text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-950/40 hover:bg-red-100 dark:hover:bg-red-900/40 border border-red-200 dark:border-red-800/60 transition-colors ml-0.5 sm:ml-1 cursor-pointer"
                >
