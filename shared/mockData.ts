import { ColleagueProfile, TaskPulseItem, ColleaguePulseFeedItem, Project, Milestone, RoadmapItem } from "./types";
...
export const mockTasks: TaskPulseItem[] = [
  // Website Building - Backend Tasks
  {
    ...
    completionNotes: "PostgreSQL schema, indexes, and session validation middleware implemented. Ready for manager sign-off.",
    completionScreenshot: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=1000&auto=format&fit=crop&q=80",
    subtasks: [
  ...
  // Digital Marketing Tasks (Facebook ads, Ads optimization, Planning, Ideas)
  {
    ...
    department: "Marketing",
    category: "Paid Campaigns & Acquisition",
  ...
  },
  {
    ...
    department: "Marketing",
    category: "Strategy & Content Planning",
  ...
  },
  {
    ...
    department: "Design",
    category: "Creative Concepts & Copy",
  ...
  // Application Design Tasks
  {
    ...
    department: "Design",
    category: "User Flows & Wireframes",
    projectBadge: "APP",
    status: "in_progress",
  ...
  // Unity Dashboard Tasks
  {
    ...
    department: "Engineering",
    category: "Analytics & UI Polish",
    projectBadge: "UNT",
    status: "in_review",
    progressPercentage: 90,
    priority: "critical",
    assignee: mockColleagues[1], // Marcus
    completionNotes: "Updated glass blur filters and currency alignment for international users.",
    completionScreenshot: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1000&auto=format&fit=crop&q=80",
    subtasks: [
  ...
  // Ui8 Platform Tasks
  {
    ...
    department: "Product",
    category: "Roadmap & Product Specs",
    projectBadge: "PRD",
    status: "completed",
    progressPercentage: 100,
    priority: "medium",
...
export const mockRoadmapItems: RoadmapItem[] = [
  {
    ...
    leadAvatar: mockColleagues[0].avatarUrl,
  ...
  },
  {
    ...
    leadAvatar: mockColleagues[3].avatarUrl,
  ...
  },
  {
    ...
    leadAvatar: mockColleagues[1].avatarUrl,
  ...
  },
  {
    ...
    leadAvatar: mockColleagues[2].avatarUrl,
