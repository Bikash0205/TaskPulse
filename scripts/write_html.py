...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .card {
    ...
    border-radius: 28px;
    padding: 22px 34px;
    box-shadow: 0 20px 40px -15px rgba(117, 110, 243, 0.4);
    display: flex;
    align-items: center;
    justify-content: center;
  }
...
<body>
  <div class="card" id="target-card">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 270 60" width="350" height="78" fill="none">
      <defs>
...
with open('scripts/render_boot_card.html', 'w', encoding='utf-8') as f:
